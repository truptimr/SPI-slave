...
static uint32_t persistence_counts = 100;
static uint32_t prev_msthb = 0;
static uint32_t tic_msthb = 0;
...
//memcpy((UINT8*)&port_status, (UINT8*)(&Status0x6000)+sizeof(Status0x6000.u16SubIndex0), sizeof(Status0x6000)-sizeof(Status0x6000.u16SubIndex0));   
  Status0x6000.Port1Status =  port_status[0];
  Status0x6000.Port2Status =  port_status[1];
  Status0x6000.Port3Status =  port_status[2];
  Status0x6000.Port4Status =  port_status[3];
  Status0x6000.Port5Status =  port_status[4];
  Status0x6000.Port6Status =  port_status[5];
  Status0x6000.Port7Status =  port_status[6];
  Status0x6000.Port8Status =  port_status[7];
  Status0x6000.Port9Status =  port_status[8];
  Status0x6000.Port10Status =  port_status[9];
  Status0x6000.Port11Status =  port_status[10];
  Status0x6000.Port12Status =  port_status[11];
  Status0x6000.Port13Status =  port_status[12];
  Status0x6000.Port14Status =  port_status[13];
  Status0x6000.Port15Status =  port_status[14];
  Status0x6000.Port16Status =  port_status[15];
}
...
void update_port_control(){
    ...
    if(Control0x7000.Loc_led == 1){
//        PORTSetBits(IOPORT_D, BIT_1);
        LED_ON();
        Status0x6000.Loc_led = 1;
    }
    else {
//        PORTClearBits(IOPORT_D, BIT_1);
        LED_OFF();
        Status0x6000.Loc_led = 0;
    }
    
//    Status0x6000.Readbackpdo = Control0x7000.Cntrlpdo;
}

void check_msthb(){
      // master hb
  if (prev_msthb == Control0x7000.Msthb)
    {
      if (tic_msthb++ > persistence_counts) // past grace period
        {
          Status0x6000.Err_msthb = 1;
        }
    }
