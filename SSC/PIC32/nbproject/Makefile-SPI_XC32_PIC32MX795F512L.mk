...
SOURCEFILES_QUOTED_IF_SPACED=../Common/9252_HW.c ../Common/coeappl.c ../Common/ecatappl.c ../Common/ecatcoe.c ../Common/ecatfoe.c ../Common/ecatslv.c ../Common/mailbox.c ../Common/objdef.c ../Common/sdoserv.c ../Common/SPI-slave.c ../Common/bootmode.c ../Common/SPI-slave_Foe.c ../Common/foeappl.c SPIDriver/SPIDriver.c SPIDriver/PIC32SPIDriver.c ../src/I2C_Functions.c ../src/TPS238x.c ../src/i2c.c ../src/power_manage.c ../src/semi_auto.c ../src/bsp.c ../src/console.c ../src/ti_wdt.c ../src/config.c ../src/Common.c ../src/bootloader.c ../src/nvmem.c exceptions.c main.c PICHW.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2108356922/9252_HW.o ${OBJECTDIR}/_ext/2108356922/coeappl.o ${OBJECTDIR}/_ext/2108356922/ecatappl.o ${OBJECTDIR}/_ext/2108356922/ecatcoe.o ${OBJECTDIR}/_ext/2108356922/ecatfoe.o ${OBJECTDIR}/_ext/2108356922/ecatslv.o ${OBJECTDIR}/_ext/2108356922/mailbox.o ${OBJECTDIR}/_ext/2108356922/objdef.o ${OBJECTDIR}/_ext/2108356922/sdoserv.o ${OBJECTDIR}/_ext/2108356922/SPI-slave.o ${OBJECTDIR}/_ext/2108356922/bootmode.o ${OBJECTDIR}/_ext/2108356922/SPI-slave_Foe.o ${OBJECTDIR}/_ext/2108356922/foeappl.o ${OBJECTDIR}/SPIDriver/SPIDriver.o ${OBJECTDIR}/SPIDriver/PIC32SPIDriver.o ${OBJECTDIR}/_ext/1360937237/I2C_Functions.o ${OBJECTDIR}/_ext/1360937237/TPS238x.o ${OBJECTDIR}/_ext/1360937237/i2c.o ${OBJECTDIR}/_ext/1360937237/power_manage.o ${OBJECTDIR}/_ext/1360937237/semi_auto.o ${OBJECTDIR}/_ext/1360937237/bsp.o ${OBJECTDIR}/_ext/1360937237/console.o ${OBJECTDIR}/_ext/1360937237/ti_wdt.o ${OBJECTDIR}/_ext/1360937237/config.o ${OBJECTDIR}/_ext/1360937237/Common.o ${OBJECTDIR}/_ext/1360937237/bootloader.o ${OBJECTDIR}/_ext/1360937237/nvmem.o ${OBJECTDIR}/exceptions.o ${OBJECTDIR}/main.o ${OBJECTDIR}/PICHW.o
...
# Source Files
SOURCEFILES=../Common/9252_HW.c ../Common/coeappl.c ../Common/ecatappl.c ../Common/ecatcoe.c ../Common/ecatfoe.c ../Common/ecatslv.c ../Common/mailbox.c ../Common/objdef.c ../Common/sdoserv.c ../Common/SPI-slave.c ../Common/bootmode.c ../Common/SPI-slave_Foe.c ../Common/foeappl.c SPIDriver/SPIDriver.c SPIDriver/PIC32SPIDriver.c ../src/I2C_Functions.c ../src/TPS238x.c ../src/i2c.c ../src/power_manage.c ../src/semi_auto.c ../src/bsp.c ../src/console.c ../src/ti_wdt.c ../src/config.c ../src/Common.c ../src/bootloader.c ../src/nvmem.c exceptions.c main.c PICHW.c
