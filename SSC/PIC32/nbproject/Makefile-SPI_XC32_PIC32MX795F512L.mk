...
# Source Files
SOURCEFILES=../Common/9252_HW.c ../Common/coeappl.c ../Common/ecatappl.c ../Common/ecatcoe.c ../Common/ecatfoe.c ../Common/ecatslv.c ../Common/mailbox.c ../Common/objdef.c ../Common/sdoserv.c ../Common/m1eph.c ../Common/bootmode.c ../Common/m1eph_Foe.c ../Common/foeappl.c SPIDriver/SPIDriver.c SPIDriver/PIC32SPIDriver.c ../src/I2C_Functions.c ../src/TPS238x.c ../src/i2c.c ../src/power_manage.c ../src/semi_auto.c ../src/bsp.c ../src/console.c ../src/ti_wdt.c ../src/config.c ../src/Common.c ../src/bootloader.c ../src/nvmem.c exceptions.c main.c PICHW.c
...
ProjectDir=/Users/tranka/Documents/m1eph/SSC/PIC32
ProjectName=SSC
...
${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o: ../Common/m1eph_Foe.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2108356922" 
	@${RM} ${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o.d 
	@${RM} ${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DPIC32_HW -D_SUPPRESS_PLIB_WARNING -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../Common" -I"../src" -MMD -MF "${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o.d" -o ${OBJECTDIR}/_ext/2108356922/m1eph_Foe.o ../Common/m1eph_Foe.c    -DXPRJ_SPI_XC32_PIC32MX795F512L=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -I /Applications/microchip/xc32/v1.40/pic32mx/include/ -mdfp=${DFP_DIR}
