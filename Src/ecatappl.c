...
/* Reset application function pointer*/
    ...
    pAPPL_FoeRead = SPIslave_FoeRead;
    pAPPL_FoeReadData = SPIslave_FoeReadData;
    pAPPL_FoeError = SPIslave_FoeError;
    pAPPL_FoeWrite = SPIslave_FoeWrite;
    pAPPL_FoeWriteData = SPIslave_FoeWriteData;
