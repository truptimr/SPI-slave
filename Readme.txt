...
SPI Driver: 
===============
SPIDriver.c and .h - This has the SPI routines to access LAN9252. It is platform independent.
-----------------------------------------------------------------------------------

===============
PIC32SPIDriver - This is specific to SPI module of PIC32MX795F512L.
...
HBI Driver:
===============
PMPDriver - This is generic HBI interface to LAN9252.

The functions to be modified for other SOCs are given below.
===============
PIC32PMPDriver- This is unique to HBI (PMP) module of PIC32MX795F512L.
		/*******************************************************************************
		Function:
